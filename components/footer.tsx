...
export function Footer() {
  return (
    <div className="relative z-10 mt-auto flex w-full flex-col">
      ...
      <footer className="border-white/10 border-t bg-[#1a1a19] px-5 pt-4 pb-[clamp(0.5rem,calc(env(safe-area-inset-bottom)-0.75rem),1.25rem)] text-white sm:px-10 sm:pt-2.5 sm:pb-2.5">
